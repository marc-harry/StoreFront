...
// check out
shoppingCart.prototype.checkout = function (serviceName, user, clearCart) {
    ...
    switch (parms.serviceName) {
        case "PayPal":
            this.checkoutPayPal(parms, clearCart, user);
            break;
        case "Google":
            this.checkoutGoogle(parms, clearCart, user);
            break;
        case "Stripe":
            this.checkoutStripe(parms, clearCart, user);
            break;
        default:
...
shoppingCart.prototype.checkoutPayPal = function (parms, clearCart, user) {
...
shoppingCart.prototype.checkoutGoogle = function (parms, clearCart, user) {
...
shoppingCart.prototype.checkoutStripe = function (parms, clearCart, user) {
    ...
    var amount = this.getTotalPrice() * 100; // Gets int value of price
    ...
    handler.open({
      ...
      description: this.items.length + ' items (£' + this.getTotalPrice() + ')',
      amount: amount 
    });
}
